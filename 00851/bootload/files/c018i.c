#pragma nolist
/* $Id: c018i.c,v 1.7.2.3 2001/09/25 21:43:14 krt Exp $ */
...
extern near unsigned long short TBLPTR;
extern near unsigned short FSR0;
...
_startup (void)
{
  _asm
    ...
    bsf FPFLAGS,RND,0 // Initialize rounding flag for floating point libs
    _endasm _do_cinit ();
